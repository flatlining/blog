...
BLOG_AUTHOR = "Matias Schertel"  # (translatable)
BLOG_TITLE = "schertel.co"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://blog.schertel.co/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://blog.schertel.co/"
BLOG_EMAIL = "matias@schertel.co"
BLOG_DESCRIPTION = "My Kung Fu Is Better Than Yours\u2026"  # (translatable)
